...
#SQL FUNCTION
connection = pymysql.connect(host="sql6.freesqldatabase.com", port=3306, user="sql6501173", passwd="j4smhVYK4S", database="sql6501173")
cursor = connection.cursor()
# READ THE DATABASE USING PANDAS
df=pd.read_sql("select datum,M01AB,M01AE,N02BA,N02BE,N05B,N05C,R03,R06 from salesdaily",connection,index_col='datum',parse_dates=True )
